...
\rotate
\tablecaption{Planet Ephemerides for 2009-Apr-01 00:00:00.0000 (CT)\label{table:eph}}
\tablecolumns{13}
\tablewidth{0pt}
...
\tablecomments{CT is a coordinate time used in connection with ephemeris. It differs from UTC by about 66 seconds (see \url{http://ssd.jpl.nasa.gov/?horizons_doc\#timesys}); The $xyz$-coordinate system is defined as follows: the
