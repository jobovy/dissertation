\chapter[Tracing the Hercules streams around the Galaxy]{Tracing the Hercules stream around the Galaxy\protect\footnote{Published as Jo Bovy 2010 \emph{ApJ} {\bf 725} 1676. Reproduced by permission of the AAS.}}\label{chap:hercules}
...
the predictions made in this \chaptername\ in the next few years (see
...
enough to verify the predictions laid out in this \chaptername. This
will also allow the dynamical properties of the bar to be tightly
