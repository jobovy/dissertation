...
\clearpage
\begin{figure}
\includegraphics[height=0.8\textheight]{figs_veldist/veldensXY.ps}
...
\begin{figure}
\begin{center}
\includegraphics[width=.3\textwidth]{figs_veldist/crossval.ps}
\includegraphics[width=.3\textwidth]{figs_veldist/aic.ps}
\includegraphics[width=.3\textwidth]{figs_veldist/mdl.ps}\\[10pt]
\includegraphics[width=.3\textwidth]{figs_veldist/mml.ps}
\includegraphics[width=.3\textwidth]{figs_veldist/bayes.ps}
\includegraphics[width=.3\textwidth]{figs_veldist/gcs_cross.ps}
\end{center}
