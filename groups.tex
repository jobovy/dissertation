...
II. The nature of the low-velocity moving groups\protect\footnote{with David~W.~Hogg}}
...
\caption[Velocity distribution in the Solar neighborhood (from
  ...
  the Solar neighborhood (from \citealt{Bovy09a}) in the Galactic
  ...
  Standard of Rest \citep{Hogg05a} is indicated by a
...
\citep{Soderblom93a} and the 500 Myr, $Z=0.016$ \citep{King03a}
...
\clearpage
\begin{figure}
\includegraphics[width=.5\textwidth]{figs_groups/clusterhist_ngc1901.eps}
\includegraphics[width=.5\textwidth]{figs_groups/clusterhist_sirius.eps}
\includegraphics[width=.5\textwidth]{figs_groups/clusterhist_pleiades.eps}
\includegraphics[width=.5\textwidth]{figs_groups/clusterhist_hyades.eps}
...
\begin{figure}
\begin{center}
\includegraphics{figs_groups/predict_plx_foreground_sirius.eps}
